...
class RelativeTimeLocalizationsBrx extends RelativeTimeLocalizations {
  ...
  String quartersPast(num quarters, Object numeric) {
    String _quartersPast0(num quarters) {
      return '$quarters खोन्दोसे सिगां';
    }
