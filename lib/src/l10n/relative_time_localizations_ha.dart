...
/// The translations for Hausa, as used in Niger (`ha_NE`).
class RelativeTimeLocalizationsHaNe extends RelativeTimeLocalizationsHa {
  RelativeTimeLocalizationsHaNe() : super('ha_NE');
