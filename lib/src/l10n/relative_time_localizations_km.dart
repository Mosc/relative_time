...
class RelativeTimeLocalizationsKm extends RelativeTimeLocalizations {
  ...
  String hoursFuture(num hours, Object numeric) {
    String _hoursFuture0(num hours) {
      return 'ក្នុង​រយៈ​ពេល $hours ម៉ោង';
    }
