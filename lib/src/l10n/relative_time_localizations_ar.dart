...
class RelativeTimeLocalizationsAr extends RelativeTimeLocalizations {
  ...
  String quartersFuture(num quarters, Object numeric) {
    String _quartersFuture0(num quarters) {
      return 'خلال $quarters ربع سنة';
    }

    String _quartersFuture1(num quarters) {
      return 'خلال $quarters أرباع سنة';
    }
    ...
    String _quartersFuture2(Object numeric) {
      return intl.Intl.selectLogic(
        numeric,
        {
          'true': 'خلال ربع سنة واحد',
          'other': 'الربع القادم',
        },
      );
    }

    String _quartersFuture3(Object numeric) {
      return _quartersFuture2(numeric);
    }
  ...
  String quartersPast(num quarters, Object numeric) {
    String _quartersPast0(num quarters) {
      return 'قبل $quarters ربع سنة';
    }

    String _quartersPast1(num quarters) {
      return 'قبل $quarters أرباع سنة';
    }
    ...
    String _quartersPast2(Object numeric) {
      return intl.Intl.selectLogic(
        numeric,
        {
          'true': 'قبل ربع سنة واحد',
          'other': 'الربع الأخير',
        },
      );
    }

    String _quartersPast3(Object numeric) {
      return _quartersPast2(numeric);
    }
