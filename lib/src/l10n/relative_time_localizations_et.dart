...
class RelativeTimeLocalizationsEt extends RelativeTimeLocalizations {
  ...
  String quartersFuture(num quarters, Object numeric) {
    String _quartersFuture0(num quarters) {
      return '$quarters kvartali pärast';
    }
