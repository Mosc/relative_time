...
class RelativeTimeLocalizationsMn extends RelativeTimeLocalizations {
  ...
  String weeksFuture(num weeks, Object numeric) {
    String _weeksFuture0(num weeks) {
      return '$weeks долоо хоногийн дараа';
    }
