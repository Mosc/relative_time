...
class RelativeTimeLocalizationsDsb extends RelativeTimeLocalizations {
  ...
  String quartersPast(num quarters, Object numeric) {
    String _quartersPast0(num quarters) {
      return 'pśed $quarters kwartalami';
    }

    String _quartersPast1(num quarters) {
      return 'pśed $quarters kwartaloma';
    }

    String _quartersPast2(num quarters) {
      return 'pśed $quarters kwartalom';
    }
