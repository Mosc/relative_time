...
class RelativeTimeLocalizationsCs extends RelativeTimeLocalizations {
  ...
  String quartersPast(num quarters, Object numeric) {
    String _quartersPast0(num quarters) {
      return 'před $quarters čtvrtletími';
    }

    String _quartersPast1(num quarters) {
      return 'před $quarters čtvrtletí';
    }

    String _quartersPast2(num quarters) {
      return 'před $quarters čtvrtletím';
    }
