...
class RelativeTimeLocalizationsEs extends RelativeTimeLocalizations {
  ...
  String yearsFuture(num years, Object numeric) {
    String _yearsFuture0(num years) {
      return 'dentro de $years años';
    }

    String _yearsFuture1(num years) {
      return 'dentro de $years año';
    }
  ...
  String quartersFuture(num quarters, Object numeric) {
    String _quartersFuture0(num quarters) {
      return 'dentro de $quarters trimestres';
    }

    String _quartersFuture1(num quarters) {
      return 'dentro de $quarters trimestre';
    }
  ...
  String quartersPast(num quarters, Object numeric) {
    String _quartersPast0(num quarters) {
      return 'hace $quarters trimestres';
    }

    String _quartersPast1(num quarters) {
      return 'hace $quarters trimestre';
    }
...
class RelativeTimeLocalizationsEsMx extends RelativeTimeLocalizationsEs {
  ...
  String quartersFuture(num quarters, Object numeric) {
    String _quartersFuture0(num quarters) {
      return 'dentro de $quarters trimetres';
    }
